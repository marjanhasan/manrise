...
export default function ProductCard({
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative aspect-[4/5] w-full overflow-hidden">
          ...
          <motion.button
            ...
            aria-pressed={wished}
            onClick={(e) => {
              // Prevent Link navigation when clicking the wishlist button
              e.stopPropagation();
              e.preventDefault();
              setWished((v) => !v);
            }}
          ...
          <div className="mt-1.5 flex w-full items-stretch gap-2">
            ...
            <button
              onClick={(e) => {
                ...
                setOpen(true); // open the quick view modal
              }}
              className="min-h-[clamp(28px,3vw,36px)] flex-1 cursor-pointer rounded-xl bg-gradient-to-tr from-gray-700 via-gray-500 to-gray-700 px-[clamp(8px,2vw,12px)] text-[clamp(11px,0.95vw,13px)] font-semibold text-white shadow-[0_0_10px_#00000022,0_0_18px_#00000011] transition-all duration-300 hover:scale-[1.02] hover:from-gray-600 hover:via-gray-400 hover:to-gray-600 hover:shadow-[0_0_18px_#00000033,0_0_30px_#00000022] active:scale-[0.98]"
            >
              Buy Now
            </button>
            ...
            <button
              onClick={(e) => {
                ...
                // put your add-to-cart logic here
              }}
      ...
      {/* Quick view modal rendered once and controlled by state */}
