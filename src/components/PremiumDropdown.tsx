      ...
      <AnimatePresence>
        {open && (
          <motion.ul
            ...
            className="absolute right-0 z-30 mt-2 w-52 overflow-hidden rounded-xl border border-neutral-200 bg-white shadow-xl dark:border-neutral-700 dark:bg-neutral-900"
          >
            {sortOptions.map((opt) => (
              <li key={opt.value}>
                <button
